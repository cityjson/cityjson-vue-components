      ...
      for (i = 0; i < boundaries.length; i++) {
        ...
        for (j = 0; j < tr.length; j += 3) {
          ...
          if (img) {
            ...
            b_geom.faceVertexUvs[0].push([(0), (1), (0)]);
          }
        }
      ...
      for (i = 0; i < boundaries.length; i++) {
        ...
        for (j = 0; j < boundaries[i].length; j++) {
          ...
          for (t = 0; t < boundaries[i][j].length; t++) {
            if (j >= 1 && count == 0) {
              inner_indices.push(inner_positions);
              count++;
            }

            //the original index from the json file
            var index = boundaries[i][j][t];
            //if this index is already there
        ...
        if (b_length == 3) {
          ...
          //triangulate
          //triangulate
          var hole_start = boundaries[i][0].length;
          if (boundaries[i].length == 1) { var tr = await earcut(pv, null, 2); }
          else { var tr = await earcut(pv, inner_indices, 2); }
          inner_indices = [];
...
/* template */
var __vue_render__$8 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"col-12 px-0 h-100",attrs:{"id":"viewer"}},[])};
var __vue_staticRenderFns__$8 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$8 = "data-v-4495808c";
  /* functional template */
  ...
  var __vue_component__$8 = normalizeComponent(
    ...
    undefined,
    undefined
  );/* eslint-disable import/prefer-default-export */var components=/*#__PURE__*/Object.freeze({__proto__:null,CityObjectCard: __vue_component__$2,CityObjectInfo: __vue_component__$1,CityObjectsTree: __vue_component__$5,CityObjectsTreeItem: __vue_component__$4,ThreeJsViewer: __vue_component__$6,TextureViewer: __vue_component__$7,InnerRing: __vue_component__$8});// Import vue components
...
}exports.CityObjectCard=__vue_component__$2;exports.CityObjectInfo=__vue_component__$1;exports.CityObjectsTree=__vue_component__$5;exports.CityObjectsTreeItem=__vue_component__$4;exports.InnerRing=__vue_component__$8;exports.TextureViewer=__vue_component__$7;exports.ThreeJsViewer=__vue_component__$6;exports.default=CityJSONComponents;