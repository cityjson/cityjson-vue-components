...
/* template */
var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{attrs:{"id":_vm.cityobject_id}},[_vm._ssrNode("<div>"+((_vm.isFolder)?("<a href=\"#\" class=\"mr-1\"><i"+(_vm._ssrClass("far text-dark text-decoration-none",[ _vm.isOpen ? 'fa-minus-square' : 'fa-plus-square' ]))+"></i></a>"):("<span class=\"mr-1\"><i class=\"far fa-square text-secondary\"></i></span>"))+" <a href=\"#\" id=\"objicon\""+(_vm._ssrAttr("title",_vm.item.type))+"><i"+(_vm._ssrClass(null,_vm.iconType))+"></i></a> <a href=\"#\" class=\"text-dark text-decoration-none\"><span"+(_vm._ssrClass(null,{ 'text-primary' : _vm.selected }))+">"+_vm._ssrEscape(_vm._s(_vm.cityobject_id))+"</span></a> "+(_vm._ssrList((_vm.singleGeometries),function(geom,i){return ("<a href=\"#\""+(_vm._ssrAttr("title",geom.type))+" class=\"badge badge-primary mr-1\"><i"+(_vm._ssrClass("mr-1",_vm.getGeometryIcon(geom.type)))+"></i><small>"+_vm._ssrEscape(_vm._s(geom.lod))+"</small></a>")}))+" "+(_vm._ssrList((_vm.geometryInstances),function(geom,i){return ("<span class=\"badge badge-secondary mr-1\"><i class=\"fas fa-external-link-alt\"></i></span>")}))+"</div> "),(_vm.isFolder)?_vm._ssrNode("<ul class=\"list-unstyled ml-4 mb-0\""+(_vm._ssrStyle(null,null, { display: (_vm.isOpen) ? '' : 'none' }))+">","</ul>",_vm._l((_vm.item.children),function(child_id){return _c('CityObjectsTreeItem',{key:child_id,staticClass:"item",attrs:{"item":_vm.getObject(child_id),"cityobject_id":child_id,"selected_objid":_vm.selected_objid}})}),1):_vm._e()],2)};
var __vue_staticRenderFns__$1 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$1 = "data-v-65afc79c";
  /* functional template */
...
/* template */
var __vue_render__$2 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('ul',{staticClass:"list-unstyled overflow-auto px-3"},_vm._l((_vm.cityobjects),function(cityobject,coid){return _c('CityObjectsTreeItem',{directives:[{name:"show",rawName:"v-show",value:(_vm.matches(coid, cityobject)),expression:"matches(coid, cityobject)"}],key:coid,attrs:{"item":cityobject,"cityobject_id":coid,"selected_objid":_vm.selected_objid}})}),1)};
var __vue_staticRenderFns__$2 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$2 = "data-v-297d0c6c";
  /* functional template */
...
/* template */
var __vue_render__$3 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"col-12 px-0 h-100",attrs:{"id":"viewer"}},[])};
var __vue_staticRenderFns__$3 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$3 = "data-v-64b2552e";
  /* functional template */
  ...
  var ThreeJsViewer = normalizeComponent_1(
    ...
    undefined,
    undefined
  );/* eslint-disable import/prefer-default-export */var components=/*#__PURE__*/Object.freeze({__proto__:null,CityObjectCard: CityObjectCard,CityObjectsTree: CityObjectsTree,CityObjectsTreeItem: CityObjectsTreeItem,ThreeJsViewer: ThreeJsViewer});// Import vue components
